...
from . views import ForgotPasswordView, PublicUserView, RegistrationView,LoginView, ResetPasswordView,UserView,LogoutView,Getuserview,AuthPing
urlpatterns = [
   ...
   path('api/ping',AuthPing.as_view(),name='AuthPing')
