...
from payment.views import CreateOrderView ,VerifyOrderView,CheckPaymentstatusview,Razorpay_WebhookView,PaymentPing
...
urlpatterns=[
    ...
    path('api/ping',PaymentPing.as_view(),name='PaymentPing')
]